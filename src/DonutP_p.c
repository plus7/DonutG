...
const CInterfaceProxyVtbl * _DonutP_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * _DonutP_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IAPI4StubVtbl,
    ( CInterfaceStubVtbl *) &_IAPI3StubVtbl,
    ( CInterfaceStubVtbl *) &_IAPI2StubVtbl,
