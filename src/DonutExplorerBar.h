...
public:
	// Ctor
	CDonutExplorerBar(CSplitterWindow &wndSplit, CHorSplitterWindow &wndAdditionalSplit)
		: m_wndSplit(wndSplit)
		, m_wndAdditionalSplit(wndAdditionalSplit)
...
private:
	...
	void _GetProfile(HWND hWndMDIClient, HWND hWndFAYT)
	{
		...
		m_wndSplit.SetSplitterPanes(m_hWnd, m_wndAdditionalSplit);
		m_wndSplit.SetSplitterPaneParents( NULL, NULL /*GetTopLevelParent()*/ );
		m_wndSplit.m_xySplitterPos = dwcxLeftSplitter;
		m_wndAdditionalSplit.SetSplitterPanes(hWndMDIClient,hWndFAYT);
		m_wndAdditionalSplit.SetSplitterPaneParents(/*m_wndSplit*/GetTopLevelParent(), NULL);
		m_wndAdditionalSplit.m_cxySplitBar = 0;
		m_wndAdditionalSplit.SetSplitterExtendedStyle(SPLIT_BOTTOMALIGNED);
		m_wndAdditionalSplit.SetSinglePaneMode(0);
