========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : TmpFavGroup
========================================================================


AppWizard が生成した TmpFavGroup には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには TmpFavGroup を構成している各ファイルの概要説明が含まれています。
...
TmpFavGroup.h
	...
	CTmpFavGroupApp アプリケーションクラスを宣言します。

TmpFavGroup.cpp
	このファイルは CTmpFavGroupApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) TmpFavGroup.pch 
