========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : LinkExtractBar
========================================================================


AppWizard が生成した LinkExtractBar には、Microsoft Foundation Class の基本的な
使い方が示されています。DLL 作成のひな型としてお使いください。

このファイルには LinkExtractBar を構成している各ファイルの概要説明が含まれています。
...
LinkExtractBar.h
	...
	CLinkExtractBarApp アプリケーションクラスを宣言します。

LinkExtractBar.cpp
	このファイルは CLinkExtractBarApp アプリケーションクラスを含むアプリケーション
	の中心となるソースファイルです。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) LinkExtractBar.pch 
